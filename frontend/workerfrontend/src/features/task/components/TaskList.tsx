              ...
              <div className="flex">
                ...
                <div className="flex-1 p-4 flex flex-col justify-between min-h-[160px]">
                  ...
                  <div className="flex items-start justify-between gap-4 mb-3">
                    <h3 className="font-bold text-gray-800 text-lg leading-tight flex-1">{t.title}</h3>
                    <span className="text-green-600 font-bold text-xl whitespace-nowrap">{t.price} €</span>
                  </div>

                  {/* ZONE 2: Metadata (Location & Date) */}
                  <div className="flex flex-wrap items-center gap-x-4 gap-y-2 mb-4 text-sm text-gray-600">
                    <span className="flex items-center">
                      <span className="material-icons text-green-500 text-base mr-1">place</span>
                      {locationStr}
                    </span>
                    <span className="flex items-center">
                      <span className="material-icons text-green-500 text-base mr-1">event</span>
                  ...
                  <div className="flex items-center gap-3 pt-3 border-t border-gray-100">
                    ...
                    {/* Username */}
                    <span className="text-sm text-gray-700 font-medium">{t.user.userName}</span>
                  </div>
                </div>
              </div>
            </div>
