            ...
            {STEP_LABELS.map((label, index) => {
                ...
                return (
                    <div key={label} className="flex items-center gap-2 text-sm font-medium text-gray-600">
                        ...
                        <span className={`hidden sm:inline ${isActive ? "text-green-600" : "text-gray-600"}`}>
                            {label}
                        </span>
                    </div>
                );
    ...
    const renderReviewStep = () => (
        <div className="space-y-10">
            ...
            <p className="text-center text-gray-600 max-w-2xl mx-auto">
                Tarkista ilmoituksen tiedot ennen {mode === "create" ? "julkaisua" : "päivitystä"}. Voit palata
                edellisiin vaiheisiin tarvittaessa.
            </p>
