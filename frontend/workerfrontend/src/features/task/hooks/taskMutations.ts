...
export function useCreateTask() {
  ...
  return useMutation({
    mutationFn: (input: CreateTaskInput) => createTask(getAccessTokenSilently, input),
    onSuccess: () => {
...
export function useUpdateTask(taskId: number) {
  ...
  return useMutation({
    mutationFn: (input: CreateTaskInput) => updateTask(getAccessTokenSilently, taskId, input),
    onSuccess: () => {
...
export function useDeleteTask() {
  ...
  return useMutation({
    mutationFn: ({ taskId }: DeleteTaskInput) => deleteTask(getAccessTokenSilently, taskId),
...
export function useUpdateTaskStatus() {
  ...
  return useMutation({
    mutationFn: ({ taskId, status }: UpdateTaskStatusInput) => updateTaskStatus(getAccessTokenSilently, taskId, status),
    onSuccess: (_, { taskId }) => {
