            ...
            <>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <input type='text' className="mt-1 text-gray-800" placeholder={`${employerDetails?.bio || "Tietoja ei löytynyt"}`} />
                    </div>
                </div>                    
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        ...
                        <input type='text' className="mt-1 text-gray-800" placeholder={`${user?.email || "Sähköpostia ei löytynyt"}`} />
                    </div>
                    <div>
