...
export const Route = createFileRoute("/_authenticated/employer/my-proflie/reviews/")({
  loader: async ({ context }) => {
    ...
    const [reviews, averageRating] = await Promise.all([
      getReviews(context.auth.getAccessToken, username, "EMPLOYER", 0, 10),
  ...
  return (
    <div className="container mx-auto px-6 py-12 max-w-4xl">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Katso mitä työntekijät ovat sanoneet yhteistyöstä</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <h2 className="text-lg font-semibold mb-4 text-gray-900">Arvostelut työnantajana</h2>
        <ReviewList reviews={reviews} profileType="EMPLOYER" limit={10} />
      </div>
    </div>
  );
}
