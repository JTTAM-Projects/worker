...
import type { TaskWizardPayload, SubmissionState } from "../../../../features/task/types";
...
function CreateTaskPage() {
    ...
    const handleSubmit = async (payload: TaskWizardPayload) => {
        ...
        if (!geocodeResult) {
            ...
            setSubmissionError("Osoitteen geokoodaus epäonnistui. Tarkista osoite ja yritä uudelleen.");
            return;
        }
