...
//   const task = taskQueries.detail(taskId!);
//   const applications = taskQueries.applications(parseInt(taskId!));
...
//           {authLoading ? "Tarkistetaan kirjautumista..." : "Uudelleenohjataan kirjautumiseen..."}
//         </div>
//       </main>
//     );
//   }
...
//     return (
//       <main className="container mx-auto px-6 py-12">
//         <div className="text-center text-red-600">Virheellinen tehtävän tunniste.</div>
...
//     return (
//       <main className="container mx-auto px-6 py-12">
//         <div className="text-center text-red-600">Virhe ladattaessa tehtävää: {"Tehtävää ei löytynyt"}</div>
//         <div className="text-center mt-4">
//           <button
//             onClick={() => navigate("/my-tasks")}
//             className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700"
