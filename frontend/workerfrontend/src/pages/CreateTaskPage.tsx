...
import { TaskWizardForm } from "../features/task/components/TaskWizardForm";
import type { SubmissionState, TaskWizardPayload } from "../features/task/types";
import { useCreateUser, useGetUserDetails, useUpdateUser } from "../features/Profile/hooks/userHooks";
import { useCreateTask } from "../features/task/hooks";

export default function CreateTaskPage() {
    const navigate = useNavigate();
    const { isAuthenticated, isLoading: authLoading, loginWithRedirect, user: authUser } = useAuth0();
